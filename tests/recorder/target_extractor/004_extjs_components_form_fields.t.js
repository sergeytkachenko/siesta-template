    ...
    t.it('Date field', function (t) {
        ...
        t.chain(
            ...
            function () {
                ...
                t.is(recorderActions[2].getTarget().target, '#form-widgets datefield[name=date] datepicker => .x-datepicker-date:textEquals(15)');
            }
        )
    })
    ...
    t.it('Radio', function (t) {
        ...
        t.chain(
            ...
            function () {
                ...
                if (Ext.getVersion().toString() == "5.1.2.748")
    ...
    t.it('Field set', function (t) {
        ...
        t.chain(
            ...
            function () {
                ...
                if (Ext.getVersion().toString() == "5.1.2.748")
                    t.is(recorderActions[2].getTarget().target, "#form-widgets checkboxfield[boxLabel=Checkbox 1] => [data-ref='displayEl']");
                else
                    t.is(recorderActions[2].getTarget().target, '#form-widgets checkboxfield[boxLabel=Checkbox 1] => .x-form-checkbox');
            }
        )
    })
})