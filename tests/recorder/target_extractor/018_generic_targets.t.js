    ...
    t.it('Should handle multiple nesting', function (t) {
        ...
        t.chain(
            ...
            function () {
                ...
                t.is(steps[0].getTarget().target, 'container(true):root(2) > :nth-child(1) textfield[inputType=text] => .x-form-text')
                t.is(steps[1].getTarget().target, 'container(true):root(2) > :nth-child(2) textfield[inputType=text] => .x-form-text')
                t.is(steps[2].getTarget().target, 'container(true):root(2) > :nth-child(3) textfield[inputType=text] => .x-form-text')
            }
        );
    })
})