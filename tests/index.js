...
harness.start(
    {
        ...
        items : [
            ...
            bowser.webkit || bowser.msie && bowser.version >= 10 
                ?
                    {
    ...
    },
    {
        ...
        items       : [
            ...
            },
            {
                ...
                items           : [
                    'ariadne/400_ext_cq_basic.t.js?ext422',
                    'ariadne/extjs_components/ext4_cq_query_with_comma.js?ext422'
                ]
            },
            {
                group           : 'Real world',
...
//                    ,
                    // disabled because of the exception from gantt "Cannot read property 'isCustomizableField' of undefined"
//                    {
//                        alsoPreload : [
//                            "../../ExtGantt4.x/resources/css/sch-gantt-all.css",
//                            "../../ExtGantt4.x/gnt-all.js"
//                        ],
...
//                    },
            ...
            {
                group      : 'Target extractor Ext JS 5.1.2',
                preload    : extJSConfigs[ '5.1.2' ],
                runCore     : 'sequential',
                loaderPath : { 'Ext.ux' : '../../extjs-5.1.2/examples/ux' },
                items      : getRecorderExtractorTests('ext512')
            },
            {
                ...
                items      : getRecorderExtractorTests('ext602').concat(
//                    {
//                        alsoPreload : [
//                            '../../ExtScheduler4.x/sch-all-debug.js',
//                            '../../ExtScheduler4.x/resources/css/sch-all.css'
//                        ],
//                        url         : 'recorder/target_extractor/015_scheduler.t.js?ext602'
//                    }
                )
            },
//            {
//                group      : 'Target extractor Ext JS 6.2.0',
//                preload    : extJSConfigs[ '6.2.0' ],
//                runCore     : 'sequential',
//                loaderPath : { 'Ext.ux' : '../../extjs-6.2.0/packages/ux/src' },
//                items      : getRecorderExtractorTests('ext620')
//            },
            {
                group               : 'Recorder UI',
                runCore             : 'sequential',
